  ...
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
        ...
        crossAxisSpacing: 8.0,
        mainAxisSpacing: 8.0,
        childAspectRatio: 0.8, // keeping 3 columns with more vertical space
      ),
      itemCount: items.length,
      itemBuilder: (context, index) {
        final item = items[index];
          ...
          children: [
            Flexible(
              child: Column(
                ...
                children: [
                  // Top row: icon (using Icon widget), file name, and the three-dot menu icon
                  Row(
                    children: [
                      Icon(
                  ...
                  // Center: Larger folder icon remains as an SVG image
                  Expanded(
                    child: Center(
